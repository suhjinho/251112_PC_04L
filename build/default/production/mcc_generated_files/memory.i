...
# 3 "mcc_generated_files/memory.c" 2
...
# 4 "mcc_generated_files/memory.c" 2
...
void FLASH_WriteByte(uint32_t flashAddr, uint8_t *flashRdBufPtr, uint8_t byte)
{
    uint32_t blockStartAddr = (uint32_t)(flashAddr & ((0x010000 -1) ^ (32 -1)));
...
int8_t FLASH_WriteBlock(uint32_t writeAddr, uint8_t *flashWrBufPtr)
{
    uint32_t blockStartAddr = (uint32_t )(writeAddr & ((0x010000 -1) ^ (32 -1)));
