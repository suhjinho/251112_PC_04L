...
# 40 "mcc_generated_files/mtouch/mtouch_button.c" 2
...
# 42 "mcc_generated_files/mtouch/mtouch_button.c" 2
...
# 266 "mcc_generated_files/mtouch/mtouch_button.c"
...
# 469 "mcc_generated_files/mtouch/mtouch_button.c"
static void Button_DefaultCallback(enum mtouch_button_names button) { }
...
void MTOUCH_Button_Baseline_Set(enum mtouch_button_names name, int value)
{
    if(name < 1u)
    {
        mtouch_button[name].baseline = (mtouch_button_baseline_t)value<<((uint8_t)4u);
    }
}
